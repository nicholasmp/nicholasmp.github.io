...
During my Fall 2017 semester at Kapiolani Community College (KCC) I took part in a project for my ICS 211 course, we were tasked with recreating and editing the simple code behind the popular video game Pokemon. All of my final submission files are in a GitHub repository, these include a simple pokedex, the pokemon from bulbasaur to blastoise(pokemon numbers 1-9), the pokemon types, an array and arraylist structure to save lists of pokemon, a tree structure to order pokemon, an interactive game, and a very simple user interface. 
